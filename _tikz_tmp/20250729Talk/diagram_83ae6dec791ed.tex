...
% Text Node
\draw (221.58,33.6) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (221.58,105.52) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (315.71,33.6) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (315.71,105.52) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (409.83,32.17) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (409.83,104.08) node [anchor=north west][inner sep=0.75pt]    {$\cdot $};
% Text Node
\draw (261.27,18.22) node [anchor=north west][inner sep=0.75pt]    {$\theta _{1}$};
% Text Node
\draw (259.92,124.66) node [anchor=north west][inner sep=0.75pt]    {$\theta _{2}$};
% Text Node
\draw (363.28,19.22) node [anchor=north west][inner sep=0.75pt]    {$m$};
% Text Node
\draw (362.59,122.78) node [anchor=north west][inner sep=0.75pt]    {$n$};
% Text Node
\draw (424.45,73.88) node [anchor=north west][inner sep=0.75pt]    {$g$};
% Text Node
\draw (330.32,73.88) node [anchor=north west][inner sep=0.75pt]    {$f$};
% Text Node
\draw (237.89,73.88) node [anchor=north west][inner sep=0.75pt]    {$f'$};
% Text Node
\draw (321.32,161.68) node [anchor=north west][inner sep=0.75pt]    {$s$};
% Text Node
\draw (363.94,62.37) node [anchor=north west][inner sep=0.75pt]    {$t$};
