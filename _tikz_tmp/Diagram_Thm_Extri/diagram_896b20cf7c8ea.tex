...
\begin{tikzcd}
	& {A_1} & \textcolor{rgb,255:red,51;green,78;blue,255} & \textcolor{rgb,255:red,51;green,78;blue,255} & {\,} \\
	{\,} & {A_1} & \textcolor{rgb,255:red,51;green,78;blue,255} & \textcolor{rgb,255:red,255;green,51;blue,54}{E} & {\,} & {\,} \\
	&& {C_2} & {C_2} & {\,} \\
	& {\,} & {\,} & {\,}
