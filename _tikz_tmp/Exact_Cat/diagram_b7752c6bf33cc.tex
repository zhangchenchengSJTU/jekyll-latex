...
\begin{tikzcd}[ampersand replacement=\&]
	...
	\arrow["\circ"{description}, draw=none, from=1-2, to=2-3]
	...
	\arrow["\circ"{description}, draw=none, from=1-5, to=2-6]
