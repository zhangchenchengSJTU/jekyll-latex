...
\begin{tikzcd}[ampersand replacement=\&]
	...
	{\,} \& {\,} \&\& {\mathsf{Ho}(\mathscr A)}
	\arrow["{\overline \gamma }"{description}, shorten <=25pt, shorten >=25pt, dashed, no head, from=1-1, to=5-1]
	\arrow[curve={height=12pt}, dashed, no head, from=1-2, to=2-1]
	\arrow[shorten >=25pt, dashed, no head, from=1-4, to=1-1]
	...
	\arrow[shorten <=25pt, dashed, from=5-1, to=5-4]
\end{tikzcd}
\end{document}
