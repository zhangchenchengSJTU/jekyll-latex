...
\begin{definition}
	(对 conflation 封闭的全子范畴). 定义外三角范畴 $(\mathcal{C}, \mathbb E, \mathfrak s)$ 的全子范畴是三元组 $(\mathcal{D},  \mathbb E|_{\mathcal{D}^{\mathrm{op}}\times \mathcal{D}}, \mathfrak s|_{\mathcal{S}})$. 其中,
	\begin{enumerate}
